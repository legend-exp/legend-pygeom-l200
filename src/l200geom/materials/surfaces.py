...
class OpticalSurfaceRegistry:
    ...
    * GLISUR model:
    ...
    def to_VM2000(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_matrix_foil = defines.MatrixFromVectors(VM2000_energy_range, VM2000_Reflectivity, "ReflectivityMatrixFoil", self.g4_registry, "eV", "")
        efficiency_matrix_foil = defines.MatrixFromVectors(VM2000_energy_range, VM2000_Efficiency, "EfficiencyMatrixFoil", self.g4_registry, "eV", "")
        # Add the matrices to the optical properties
        self._to_VM2000.addProperty("REFLECTIVITY", reflectivity_matrix_foil) # der VM2000 zugewandte Seite --> reflectivity=0
    ...
    def water_to_VM2000(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_matrix_front = defines.MatrixFromVectors(VM2000_energy_range, Reflectivity_front, "ReflectivityMatrixFoilFront", self.g4_registry, "eV", "")

        # Make matrices for the properties
        efficiency_matrix_border_foil = defines.MatrixFromVectors(VM2000_energy_range, Efficiency_Border, "EfficiencyMatrixBorderFoil", self.g4_registry, "eV", "")
        transmittance_matrix_border_foil = defines.MatrixFromVectors(VM2000_energy_range, Transmittance_Border, "TransmittanceMatrixBorderFoil", self.g4_registry, "eV", "")
        # Add the matrices to the optical properties
    ...
    def to_steel(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_steel_matrix = defines.MatrixFromVectors(photon_energy, reflectivity_steel, "ReflectiveSteelMatrix", self.g4_registry, "eV", "")
        efficiency_steel_matrix = defines.MatrixFromVectors(photon_energy, efficiency_steel, "EfficiencySteelMatrix", self.g4_registry, "eV", "")
    ...
    def to_photocathode(self) -> g4.solid.OpticalSurface:
        ...
        data = np.loadtxt(path + '/PMT_QE.csv', delimiter=',')
        ...
        # Make matrices for the properties
        efficiency_matrix = defines.MatrixFromVectors(photon_energy, PMT_quantum_efficiencies*collection_efficiency, "EfficiencyMatrix", self.g4_registry, "eV", "")
    ...
    def acryl_to_air(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_matrix_air = defines.MatrixFromVectors(photon_energy_air, reflectivity_air, "ReflectivityMatrixAir", self.g4_registry, "eV", "")
        transmittance_matrix_air = defines.MatrixFromVectors(photon_energy_air, transmittance_air, "TransmittanceMatrixAir", self.g4_registry, "eV", "")
    ...
    def water_to_acryl(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_matrix_acryl = defines.MatrixFromVectors(photon_energy_acryl, reflectivity_acryl, "ReflectivityMatrixAcryl", self.g4_registry, "eV", "")
        efficiency_matrix_acryl = defines.MatrixFromVectors(photon_energy_acryl, transmittance_acryl, "TransmittanceMatrixAcryl", self.g4_registry, "eV", "")
    ...
    def air_to_borosilicate(self) -> g4.solid.OpticalSurface:
        ...
        reflectivity_matrix_borosilicate = defines.MatrixFromVectors(photon_energy, reflectivity, "ReflectivityMatrixBorosilicate", self.g4_registry, "eV", "")
        efficiency_matrix_borosilicate = defines.MatrixFromVectors(photon_energy_borosilicate, transmittance_borosilicate, "TransmittanceMatrixBorosilicate", self.g4_registry, "eV", "")
